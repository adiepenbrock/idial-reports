...
export default function DefaultReportLayout({
  report,
  locale,
  dictionary,
  yearSummaries,
            ...
            <section className="report-hero" aria-label={meta.title}>
              <div className="report-hero-eyebrow">
                <p className="meta-label">
                  {dictionary.published}: {formatPublishedDate(report.meta.publishedAt, localeTag)}
                </p>
              ...
              {meta.forewordLead ? (
                <p className="hero-foreword">{meta.forewordLead}</p>
              ) : null}
